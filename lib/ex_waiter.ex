defmodule ExWaiter do
  ...
  * `:num_attempts` - The number of attempts before retries are exhausted. (default: 5)
  ...
  Takes an anonymous function that checks whether the given condition has been met. It MUST return either `{:ok, value}` or `{:error, value}`. If the condition has been met, a tuple with `{:ok, value, %Waiter{}}` will be returned. If retries are exhausted prior to the condition being met, an exception will be raised.
